...
def get_zy_dan_graph(h_params, word_embeddings, pos_embeddings):
    ...
    x_to_y = DANLink(xin_size, h_params.encoder_h, yout_size, h_params.encoder_l, Categorical.parameter_activations,
                      #embedding=pos_embeddings,
                      highway=h_params.highway, dropout=h_params.dropout)
...
def get_y_dan_graph(h_params, word_embeddings, pos_embeddings):
